...
export default function QuickMatchPage() {
  ...
  const reset = () => { clearLocalV2Profile(); setProfile(initialProfile); setStage("input"); setStep(1); setResults([]); setMigrationResults([]); setComparisonIds([]); setError(""); setValidationError(""); };
